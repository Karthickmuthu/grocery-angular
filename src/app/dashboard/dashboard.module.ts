...
import { GroceryListComponent } from '../pages/grocery/grocery-list/grocery-list.component';
@NgModule({
  imports: [
    CommonModule,
    DemoMaterialModule,
  ...
  declarations: [GroceryListComponent,  DashboardComponent, SalesOverviewComponent, OurVisiterComponent, ProfileComponent, ContactsComponent, ActivityTimelineComponent]
})
